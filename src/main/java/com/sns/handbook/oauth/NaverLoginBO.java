...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "9p2j68Qiov9kpjGNrVqL"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "ROYTShRRlY";        // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:7777/navercallback"; //로그인 성공시 보내는 url
    private final static String SESSION_STATE = "oauth_state";
    /* 프로필 조회 API URL */
    private final static String PROFILE_API_URL = "https://openapi.naver.com/v1/nid/me"; //네이버 회원의 프로필을 조회합니다.
